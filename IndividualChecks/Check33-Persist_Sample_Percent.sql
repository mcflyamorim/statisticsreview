...
Note 1: PERSIST_SAMPLE_PERCENT is only availabe on SQL Server 2016 SP1 CU4, 2017 CU1, and higher builds, but, column has_persisted_sample sys.stats is only available on SQL2019 :-( ... 
