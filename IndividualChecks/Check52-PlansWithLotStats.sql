...
OR statement_plan.exist('//p:Field[@FieldName="wszStatName"]') = 1
...
SELECT  TOP 1000
        ...
        number_of_loaded_stats_internal_stats = statement_plan.value('count(//p:Field[@FieldName="wszStatName"])', 'float'),
...
ORDER BY number_of_loaded_stats + number_of_loaded_stats_internal_stats DESC